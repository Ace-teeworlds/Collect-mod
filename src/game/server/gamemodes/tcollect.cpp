...
CGameControllerTCOLLECT::CGameControllerTCOLLECT(class CGameContext *pGameServer)
...
void CGameControllerTCOLLECT::Tick()
{
	int totalscore = 0;
...
bool CGameControllerTCOLLECT::OnEntity(int Index, vec2 Pos)
{
...
void CGameControllerTCOLLECT::GenerateFood()
{
	m_Amount++;
